...
window.fathom.init = function(application_id, callback)  {
    //set style of button
        ...
        if (count <= maxRetries) {
            ...
            .then((response) => {
                ...
                if (response.data.status === "in progress" || response.data.status === "timed out awaining pin") {
                    ...
                    popup.close()
                    window.fathom.session_id = session_id
                    callback(session_id);
                } else {
...
//     // console.log("success")
//     onFathomLogin(session_id)

//     //set Session_id in div
//     const newDiv = document.createElement("div"); 
//     const newContent = document.createTextNode(session_id); 
//     newDiv.style.display = "none"
//     newContent.id = "fathom_session_id"
//     newDiv.appendChild(newContent);  
//     const currentDiv = document.getElementById("fathom-signup");
//     document.body.insertBefore(newDiv, currentDiv);
// };
},{"axios":2,"uuid":28}],2:[function(require,module,exports){
...
},{"./adapters/http":3,"./adapters/xhr":3,"./helpers/normalizeHeaderName":24,"./utils":27,"_process":43}],18:[function(require,module,exports){
'use strict';
